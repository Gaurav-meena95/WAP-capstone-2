...
const PropertyDetails = () => {
  ...
  return (
    <div className="">
      ...
      <div className="my-40 flex justify-center items-start mx-10 max-[432px]:flex-wrap max-[432px]:my-20">
        <div className="w-1/2 max-[432px]:w-full ">
          <div className="  mb-10">
            <h1>Description</h1>
            <p className="my-10 max-[432px]:text-[15px]">
          ...
          <div className="disply_flex  max-[432px]:flex-wrap">
            <div className="p-10 bg-gray-900 w-60 mx-1 rounded-lg border my-5 border-gray-700 ">
        ...
        <div className="w-1/2 mx-5  max-[432px]:w-full max-[432px]:mx-0 max-[432px]:mt-10">
